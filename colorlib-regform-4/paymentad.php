...
$card=$_POST['cardno'];
  ...
  $holder=$_POST['cardholder'];
    ...
    if($no!=0){ 
        mysqli_query($con,"UPDATE account SET status='11' where f_name='$f_name'");
         mysqli_query($con,"UPDATE booking SET status='11' where f_name='$f_name'");
         ?>
...
{
    echo "<script>";
       echo("location.href='../user/re_am.php'");
       echo "</script>";
}
?>
<!DOCTYPE html>
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="section colm colm6"><form method="post" action="refund_request.php">
