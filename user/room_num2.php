...
$user=$_SESSION['sess'];
$a=$_GET['b'];
$sql90="select * from booking where f_name='$a'";
...
$sql=mysqli_query($con,"INSERT INTO `roomnum` (`r_id`, `room_num`, `room`, `f_name`, `status`) VALUES (NULL, '$room_num', '$room', '$f_name', '0')");
    
    if($sql==true)
    {
         echo "<script>";echo "alert('Successfully added!')";echo"</script>";
         echo "<script>";
...
<center>
   ...
   <?php
        ...
        <input id="f_name" type="text" name="f_name" placeholder="" value="<?php echo $fetch90['f_name'];?>" readonly>
           <br>
           <br><label>Room&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <input id="room" type="text" name="room" placeholder="" value="<?php echo $tt3['room'];?>" readonly>
           <br>
           <br><label>Room Number</label>
        <input id="room_num" type="text" name="room_num" placeholder="Add Room Num
                                                                er" >
    ...
    if ( $(this).val().match('^[a-zA-Z]{6,16}$') ) {
      ...
      <?php
       ...
       <br> <br> 
     <input id="submit" type="submit" name="submit" value="ADD" style="position:relative;background-color:red;color:white;">
        <script>
