...
<br>
<u><h2 style="position:relative;left:550px;top:-50px;">STUDENT REPORT</h2>	</u>
        ...
        $sum=0;
                    ...
                    $room=$tt3['room'];
						...
						<tr>
                            ...
                            <td style="font-size:15px;"><?php echo $tt3['room']?></td>
                            <td style="font-size:15px;"><?php echo $tt4['category']?></td>
...
mysqli_close($con);
    ...
    <td></td><td></td><td> <p> Total amount=        <?php   echo $sum;?></p></td><td></td><td></td><td style="font-size:15px;" align="center"><a target="_blank" href="Codementor html to pdf/index.php">Booking Detals &nbsp;&nbsp;<i class="fa fa-download"></i></a>
