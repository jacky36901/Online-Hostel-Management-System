...
$sql=mysqli_query ($con,"INSERT INTO `replay` (`rep_id`, `replay`, `status`) VALUES (NULL, '$do ', '1')");
...
$sql="select * from enquiries where status=1";
$exe=mysqli_query($con,$sql);
?>
<center><h2 style="color:blue"><b style="font-size:25px;">ENQUIRIES</b></h2></center>
<form method="POST">
    <center><br><br>
				<table class="table table-striped">
                    ...
                    <tr><td></td><td></td><td><b style="font-size:14px;">Enquiry  :</b></td><td style="font-size:14px;" align="center"><?php echo $fetch2['search']?>
                                   &nbsp;
                                   </td>
							</tr>
