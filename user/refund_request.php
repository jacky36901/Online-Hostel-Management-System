...
$sql="SELECT * FROM refund where status='1'";
                            ...
                            <tbody>
                                <tr>
                                     <td><div class="f_name"><?php echo $row['f_name'];?></div></td>
                                             ...
                                             <td style="font-size:14px;"><a href="tourapp.php?b=<?php echo $row['f_name'];?>">Accept</a></td>
                                    <td style="font-size:14px;"><a href="tourdel.php?b=<?php echo $row['f_name'];?>">Reject</a></td>
