          ...
          <li class="nav-item  class=" active" ">
            ...
            <a class="nav-link " data-target="#PageSubmenu9" data-toggle="collapse">
              ...
              <li class="nav-item"><a class="nav-link " href="view_students.php" style="color:white;font-family: Arial, Helvetica, sans-serif;font-size:14px;">View Students</a></li>
                     <li><a class="nav-link " href="payment_view.php" style="color:white;font-family: Arial, Helvetica, sans-serif;font-size:14px;">View Payment</a></li>
    ...
    <tr><td></td><td></td><td><b style="font-size:14px;">Phone :</b></td><td style="font-size:14px;" align="center"><?php echo $fetch2['phone']?>
                    ...
                    <tr></tr>
							...
							<tr><td></td><td></td><td colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <a href="edit_in.php?b=<?php echo $fetch2['Reg_id'];;?>"><font color="red"><b style="font-size:16px;">Edit</b></font></a></td>
                                <td><a href="delete_student.php?b=<?php echo $fetch2['Reg_id'];;?>"><font color="red"><b style="font-size:16px;">Delete</b></font></a></td>
