...
$user=$_SESSION['sess'];
 ...
 $sql2="select * from registration where status=1";
...
<body class="">
  ...
  <div class="main-content">
    ...
    <h2><b>STUDENTS </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h2><br> 
    	...
    	<div class="col-md-3 product-grid">
    		...
    		<div class="product-items">
	    		    <div class="project-eff">
						...
						<div id="nivo-lightbox-demo"> <p> <a href="../images/<?php echo $result2['photo'];?>" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"><span class="rollover1"> </span> </a></p></div>     
							<img src="../images/<?php echo $result2['photo'];?>" alt="" width="246px" height="246px" style="width:100%">
                       
                       
					</div>
	    		<div class="produ-cost">
	    			 <h4 style="color:black;">Name :   <b><?php echo $result2['username'];?></b></h4>
                    <!--<h4 style="color:black;">Age : <b></b></h4>
                     <h4 style="color:black;">Gender : <b></b></h4>-->
                     <a href="view_students.php?b=<?php echo $result2['username'];?>">
                                <font color="black" style="font-size:15px;color:red;"><i class="fa fa-pencil-square-o icon_9"> </i>View</font></a>
	    		</div>
             <?php
                        }
                        ?>
        ...
        <!--<h2><a href="Codementor%20html%20to%20pdf/index.html"><font color="black" style="font-size:15px;"><i class="fa fa-trash-o"></i>Print all</font></a></h2>-->
