...
<center><h2 style="color:blue"><b style="font-size:25px;">REFUND REPORT VIEW</b></h2></center>
<form method="POST">
    <br><br>
				<table class="table table-striped">
					...
					<tbody>
                        ...
                        <tr><td style="font-size:14px;">ACCEPTED REFUNDS</td><td style="font-size:14px;"><a href="state_add.php"></a></td><td style="font-size:14px;"><a href="refund_report1.php">view</a></td><td style="font-size:14px;"></td></tr>
<tr><td style="font-size:14px;">REJECTED REFUNDS</td><td style="font-size:14px;"><a href="district_add.php"></a></td><td style="font-size:14px;"><a href="refund_report.php">view</a></td><td style="font-size:14px;"></td></tr>
