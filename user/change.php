...
$sql90="select * from login where status='11'";
...
$sql78="update login set password='$password' where status='11'";
...
<center>
   ...
   <?php
        ...
        <input id="password" type="text" name="password" placeholder="New Password" value="<?php echo $fetch90['password'];?>" >
