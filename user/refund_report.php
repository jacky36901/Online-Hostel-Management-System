...
$sql="SELECT * FROM refund where status='10'";
$result=mysqli_query($con,$sql);
$sql33="SELECT * FROM refund where status='2'";
$result11=mysqli_query($con,$sql33);
        ...
        <div class="col-xl-12 mb-2 mb-xl-0">
          ...
          <div class="card shadow">
            <div class="card-header bg-transparent">
              ...
              <h4 class="card-title"><b>REFUND REJECTED STUDENTS</b></h4>
